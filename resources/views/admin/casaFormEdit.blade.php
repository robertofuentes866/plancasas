...
<div class="row">
    ...
    <div class="col-4">
                <div class="mb-3 row">
                <label class="col-lg-5 col-md-6 col-sm-12 col-form-label">Aires Acondicionado:</label>
                <div class="col-lg-4 col-md-6 col-sm-12"> 
...
<div class="row">
    ...
    <div class="col-4">
                <div class="mb-3 row">
                <label class="col-lg-4 col-md-6 col-sm-12 col-form-label">Abanicos de Techo:</label>
                <div class="col-lg-4 col-md-6 col-sm-12"> 
