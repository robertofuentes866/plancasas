...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-2 row-cols-1 g-2">
            ...
            <div class="col">
                <div class="form-floating">
                    <input id="area_construccion" name="area_construccion" value="{{old('area_construccion')}}" type="number" min="30" max="1000" class="form-control">     
            ...
            <div class="col">
                <div class="form-floating">
                    <input id="aires_acondicionado" name="aires_acondicionado" value="{{old('aires_acondicionado')}}" type="number" min="1" max="25" class="form-control">     
            ...
            <div class="col">
                <div class="form-floating">
                    <input id="habitaciones" name="habitaciones" value="{{old('habitaciones')}}" type="number" min="1" max="25" class="form-control">     
            ...
            <div class="col">
                <div class="form-floating">
                    <input id="banos" name="banos" value="{{old('banos')}}" type="number" min="1" max="25" class="form-control">     
            ...
            <div class="col">
                <div class="form-floating">
                    <input id="abanicos_techo" name="abanicos_techo" value="{{old('abanicos_techo')}}" type="number" min="1" max="25" class="form-control">     
